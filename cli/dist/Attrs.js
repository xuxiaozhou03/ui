...
const handleStyle = (value) => {
    const obj = value
        ...
        return Object.assign(Object.assign({}, acc), { [rename(k1.trim())]: v1.trim() });
    }, {});
    return obj;
};
...
class Attrs {
    constructor(attrs, isCustomElement) {
    ...
    formatAttr(key, value) {
        const newKey = this.formatKey(key);
        this.config = Object.assign(Object.assign({}, this.config), this.formatValue(value, newKey));
    }
    addDynamicKey(key) {
        if (key.startsWith(":")) {
            return key;
