<template>
  <demo-block title="基础用法" padding>
    ...
    <van-tag custom-class="demo-margin-right" type="warning">标签</van-tag>
  </demo-block>

  <demo-block title="圆角样式" padding>
    <van-tag custom-class="demo-margin-right" round type="primary"
      >标签</van-tag
    >
    <van-tag custom-class="demo-margin-right" round type="success"
      >标签</van-tag
    >
    <van-tag custom-class="demo-margin-right" round type="danger">标签</van-tag>
    <van-tag custom-class="demo-margin-right" round type="warning"
      >标签</van-tag
    >
  </demo-block>
  ...
  <demo-block title="标记样式" padding>
    ...
    <van-tag custom-class="demo-margin-right" mark type="warning">标签</van-tag>
  </demo-block>

  <demo-block title="空心样式" padding>
    <van-tag custom-class="demo-margin-right" plain type="primary"
      >标签</van-tag
    >
    <van-tag custom-class="demo-margin-right" plain type="success"
      >标签</van-tag
    >
    <van-tag custom-class="demo-margin-right" plain type="danger">标签</van-tag>
    <van-tag custom-class="demo-margin-right" plain type="warning"
      >标签</van-tag
    >
  </demo-block>
  ...
  <demo-block title="自定义颜色" padding>
    ...
    <van-tag custom-class="demo-margin-right" color="#7232dd" plain
      >标签</van-tag
    >
    <van-tag
  ...
  <demo-block title="标签大小" padding>
    <van-tag custom-class="demo-margin-right" type="danger">标签</van-tag>
    <van-tag custom-class="demo-margin-right" type="danger" size="medium"
      >标签</van-tag
    >
    <van-tag custom-class="demo-margin-right" type="danger" size="large"
      >标签</van-tag
    >
  </demo-block>
...
function onClose(type: "primary" | "success") {
  show[type] = false;
}
</script>
<style>
