<template>
  ...
  <demo-block title="自定义内容">
    <van-grid :column-num="3" :border="false">
      <van-grid-item v-for="(index, i) in array3" :key="index" use-slot>
        <image
...
const array3 = ref([0, 1, 2]);
const array4 = ref([0, 1, 2, 3]);
const array6 = ref([0, 1, 2, 3, 4, 5]);
const array8 = ref([0, 1, 2, 3, 4, 5, 6, 7]);
</script>
<style scoped></style>
