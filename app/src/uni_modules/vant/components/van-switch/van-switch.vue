<template>
  <div
    :class="[
      'van-switch',
      { 'van-switch--on': isChecked, 'van-switch--disabled': props.disabled },
      customClass,
    ]"
    :style="rootStyle"
    @click="onClick"
  >
    <div :class="['van-switch__node', nodeClass]">
      <van-loading
        v-if="props.loading"
        :color="loadingColor"
...
const rootStyle = computed(() => {
  const currentColor = isChecked.value
    ? props.activeColor
    : props.inactiveColor;
  return {
