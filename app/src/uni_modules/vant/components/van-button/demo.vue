<template>
  ...
  <demo-block title="朴素按钮" padding>
    <van-button type="primary" plain class="demo-margin-right"
      >朴素按钮</van-button
    >
  ...
  <demo-block title="细边框" padding>
    <van-button type="primary" plain hairline class="demo-margin-right"
      >细边框按钮</van-button
    >
  ...
  <demo-block title="禁用状态" padding>
    <van-button type="primary" disabled class="demo-margin-right"
      >禁用状态</van-button
    >
  ...
  <demo-block title="按钮形状" padding>
    <van-button type="primary" square class="demo-margin-right"
      >方形按钮</van-button
    >
  ...
  <demo-block title="按钮尺寸" padding>
    ...
    <van-button type="primary" size="small" class="demo-margin-right"
      >小型按钮</van-button
    >
  ...
  <demo-block title="块级元素" padding>
    <van-button type="primary" custom-class="demo-margin-bottom"
      >普通按钮</van-button
    >
  ...
  <demo-block title="自定义颜色" padding>
    ...
    <van-button color="#7232dd" class="demo-margin-right" plain
      >单色按钮</van-button
    >
...
// Vue 3 <script setup>，无需 VantComponent
</script>
<style>
.row {
  height: 44px;
