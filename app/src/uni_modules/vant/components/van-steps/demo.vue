<template>
  <demo-block title="基础用法">
    ...
    />
    <van-button class="demo-margin-left" @click="nextStep">下一步</van-button>
  </demo-block>
  ...
  <demo-block title="自定义图标">
    <van-steps :steps="customIconSteps" :active="active" />
  </demo-block>
...
import { ref } from "vue";
import icons from "../van-icon/icons";
