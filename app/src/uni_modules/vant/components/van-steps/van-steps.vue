<template>
  <div :class="[`van-steps`, `van-steps--${props.direction}`, customClass]">
    <div class="van-step__wrapper">
      <div
        ...
        :class="[
          `van-step`,
          `van-step--${props.direction}`,
          `van-step--${stepStatus(index)}`,
          'van-hairline',
        ]"
        :style="
          stepStatus(index) === 'inactive' ? { color: inactiveColor } : {}
        "
      >
        <div
        ...
        <div class="van-step__circle-container">
          <template v-if="index !== active">
            <template v-if="item.inactiveIcon || inactiveIcon">
              <van-icon
                :color="
                  stepStatus(index) === 'inactive' ? inactiveColor : activeColor
                "
